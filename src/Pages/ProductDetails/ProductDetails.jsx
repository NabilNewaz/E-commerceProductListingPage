    ...
    return (
        <PhotoProvider>
            <div>
                ...
                <div className={isLoading ? 'hidden' : 'text-gray-700 body-font overflow-hidden bg-white dark:bg-[#2a303c]'}>
                    <div className="container px-5 py-5 mx-auto">
                        <div className="lg:w-4/5 mx-auto flex flex-wrap items-center">
                            <PhotoView key={product?.id} src={product?.image}>
                                <img alt={product?.id} className="lg:w-1/2 w-full object-cover md:p-20 p-10 object-center rounded border  dark:border-gray-400 border-gray-200" src={product?.image} />
                            </PhotoView>
                            <div className="lg:w-1/2 w-full lg:pl-10 mt-6 lg:mt-0">
                                <h2 className="text-sm title-font text-gray-500 tracking-widest uppercase">{product?.category}</h2>
                                <h1 className="text-gray-900 text-3xl title-font font-medium mb-1 dark:text-gray-400">{product?.title}</h1>
                                ...
                                <div className="flex items-center">
                                    <span className="title-font font-bold text-3xl text-gray-900 dark:text-gray-400">${product?.price}</span>
